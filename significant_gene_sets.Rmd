...
dir.path = "/home/ismini/Documents/RNA_cor/iRNA/iRNA_project/results/ToTest/testing"
...
file.to.use = "ALPL_0.015_0.05_E18_S198_E18_p.tsv"
...
### Common genes with fdr<0.05:
  ...
  if(is.null(dim(common1)) & is.null(dim(common2)) &is.null(dim(common3))){
  ...
  if(is.null(dim(common2))){
    common2 <- apply (matrix(common2, nrow=1), 2, function (x) {length (x) <- max_rows; return (x)})
  }else{
