...
getwd()
x <- c("tidyverse", "SingleCellExperiment", "Matrix", "AnnotationHub", "ensembldb", "ggplot2", "scales")
...
- If your data are the output from 10X platform then you have to set _count.matrix_ = FALSE and provide the directory where these data are to the varable _input.dir_

```{r}

count.matrix = TRUE
#provide the filename of the count matrix you'd like to analyse
input = "/home/ismini/Documents/RNA_cor/iRNA/S190/scWCP10_S190_matrix.count.csv"

#provide the directory to access data from 10X platform
input.dir = "path of directory"
...
- In case they are provided with their Ensembl ids you have to set gene.name = FALSE 
...
```{r}
already = TRUE
input.data = "se_filtered_S190_0.02_0.07.rds"
if(already){
